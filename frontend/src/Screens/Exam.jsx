      ...
      <div className="flex justify-between items-center w-full">
        ...
        {!dataLoading && loginType !== "Student" && (
          ...
          className="px-5 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg shadow-lg transition">
            <IoMdAdd className="text-2xl" /> Add Exam
          </CustomButton>
        )}
      </div>
        ...
        <div className="mt-8 w-full bg-white rounded-2xl shadow-lg overflow-hidden">
          <table className="min-w-full divide-y divide-gray-200 bg-white rounded-lg">
            <thead className="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-left">
              <tr >
                <th className="py-3 px-6 text-left font-semibold">Exam Name</th>
                <th className="py-3 px-6 text-left font-semibold">Date</th>
                <th className="py-3 px-6 text-left font-semibold">Semester</th>
                <th className="py-3 px-6 text-left font-semibold">Exam Type</th>
